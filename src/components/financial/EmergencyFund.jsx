    ...
    <div className="glass-card p-5">
      ...
      <div className="flex justify-between text-sm">
        ...
        {metrics.emergencyFundGap > 0 && (
          <span className="font-normal text-gap">
      ...
      {metrics.emergencyFundGap > 0 && (
        <motion.div
          className="mt-4 rounded-lg border border-underinsured/30 bg-underinsured/10 p-4 backdrop-blur-sm"
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.6, ease: [0.4, 0, 0.2, 1] }}
        >
          <p className="text-sm font-normal text-underinsured">
